    ...
    <div class="container mx-auto p-6">
        ...
        <form action="{{ route('roles.update', $role) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="name" name="name" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" value="{{ $role->name }}" required>
            </div>
